	...
	_attachSVG: function(container, settings) {
		...
		try {
			if (!svg) {
				...
				svg.setAttributeNS(this.xmlNS, 'xmlns:xlink', 'http://www.w3.org/1999/xlink')
		...
		if (node.nodeType == 1) { // element
			...
			for (var i = 0; i < node.attributes.length; i++) {
				...
				if (attr.nodeName != 'xmlns' && attr.nodeValue) {
					...
					else if (attr.localName == 'href' && attr.nodeValue) { // ===== (mitja)
						newNode.setAttributeNS($.svg.xlinkNS,// ===== (mitja)
							attr.localName || attr.baseName, attr.nodeValue);// ===== (mitja)
					}// ===== (mitja)
					else {
